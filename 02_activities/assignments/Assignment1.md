...
```
I encounter databases in academic journals and professional statistical websites that are not open to the public. These subscription-based journal systems create access inequalities. If anyone is not affiliated with an institution that pays for those databases, they are locked out of the knowledge loop. In daily life I can only access a paper through the authentication of my academic institution. This suggests the embedded value of knowledge being consumable goods, instead of any human educating themselves being a basic right.
I also work with a lot of datasets collected by myself (e.g., several waves of data collected from the same sample over time). I often utilize online research recruitment platforms such as CloudResearch and Prolific, which are quite European-American-centric. The values in how accessible it is to collect data from certain groups of people but not others reflect a lack of inclusivity in considerations for knowledge generalization.
These platforms are also designed to protect participant anonymity, which is great for encouraging honest responses and building trust. At the same time, however, this anonymity creates challenges for researchers trying to understand the context of participants’ experiences. People who sign up for studies can lie about their identities to both the researchers and the platform, with challenges for verification. Without identifiable data, it is difficult to understand how someone’s unique background might shape their responses. The data collected being anonymous, in my opinion, is a good protective measure against the intrusion of technology in people's daily life as it prevents researchers from taking advantage of their access to data, but also creates challenges for data accuracy and understanding humans as complex individuals.
```
